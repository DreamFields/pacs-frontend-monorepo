...
import View2D from '../../src/WebGLView/View2D';
import LeftToolsBar from '../../src/WebGLView/ui/LeftToolsBar';
        ...
        <div style={{ width: '100%', height: '100%', backgroundColor: '#313131' }}>
          ...
          >
            <div style={{ minHeight: 0, minWidth: 0, border: '1px solid black' }}>
              <View2D orientation="Axial" />
            </div>

            <div style={{ minHeight: 0, minWidth: 0, border: '1px solid black' }}>
              <View2D orientation="Coronal"/>
            </div>

            <div style={{ minHeight: 0, minWidth: 0, border: '1px solid black' }}>
              <View2D orientation="Sagittal" />
            </div>
          </div>
        </div>
      </div>
