    ...
    <div style={bodyStyle}>
      <div>
        ...
        >
          ...
          <span style={{ display: 'inline-block', width: '28%' }}>设置选择文件类型：</span>
          <Select
          ...
          >
            ...
            <Option value="DICOM 3.0_via_(X)MedCon">DICOM 3.0_via_(X)MedCon</Option>
          ...
          <p style={{ fontSize: 6, color: 'red', width: '72%', float: 'right', marginTop: 5 }}>
            {updateTips(fileType)}
          </p>
        </Modal>
      </div>
