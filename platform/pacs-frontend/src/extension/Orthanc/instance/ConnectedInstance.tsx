import { Button, Card, List, Layout, Popconfirm, Image, BackTop, Typography } from 'antd';
import { DownloadOutlined, DeleteFilled, ToTopOutlined } from '@ant-design/icons';
        ...
        <Sider theme="light" width="20%">
          <div style={{ paddingRight: '12px' }}>
            ...
            >
              ...
              <p className={style.custom_p}>Modality: {curSeriesInfo?.MainDicomTags.Modality}</p>
              <p className={style.custom_p}>
              ...
              <p className={style.custom_p}>
                SeriesInstanceUID: {curSeriesInfo?.MainDicomTags.SeriesInstanceUID}
              </p>
              <p className={style.custom_p}>
            ...
            <Card title="操作" headStyle={{ backgroundColor: '#39bbdb' }} size="small">
              <p>
                ...
                <Popconfirm
                  ...
                  cancelText="取消"
                >
                  <Button style={{ marginTop: 8 }} type="primary" icon={<DeleteFilled />} block>
                    删除该 Instance
                  </Button>
                </Popconfirm>
              </p>
                  ...
                  description={curHeaderKey.map((key: any, index: number) => {
                    return (
                      <div>
                        ...
                        <span style={{ fontWeight: 700 }}>{curHeaderValue[index].Value}</span>
                      </div>
                    );
                  })}
                />
                  ...
                  description={mainDicomKey.map((key: any, index: number) => {
                    return (
                      <div>
                        ...
                        <span style={{ fontWeight: 700 }}>{mainDicomValue[index].Value}</span>
                      </div>
                    );
                  })}
                />
