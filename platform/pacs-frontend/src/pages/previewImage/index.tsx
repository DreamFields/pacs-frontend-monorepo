 ...
 */
import { Button, Card, List, Layout, Tooltip, Popconfirm, Popover, Image, BackTop } from 'antd';
...
import style from '../../extension/Orthanc/Series/index.less';
...
const Detect: React.FC<DeteceProps> = (props) => {
  const { dispatch, curPatientInfo, curStudyInfo, curSeries, curInstanceList, fetchSeriesLoading } =
    props;
  ...
  return (
    <>
      ...
      <Layout>
        ...
        <div style={{ padding: '10px', margin: '20px' /* marginLeft: '130px'  */ }}>
          <Card
            style={{ margin: '0 auto' }}
            title="图像预览"
                    ...
                    return (
                      <div style={{ display: 'inline-block', margin: '10px' }}>
                        <Image
                          ...
                          width={250}
                          src={`/api/instances/${item.ID}/preview`}
                          onClick={() => {
